...
<head>
  ...
  <style>
    ...
    .how-it-works,.free-tools,.preview-countries,.paid-services,.final-cta{padding:clamp(46px,7vw,92px) clamp(18px,5vw,72px)}
    ...
    .paid-services{background:linear-gradient(135deg,#073568 0%,#1269c8 100%);color:#fff}
    ...
    .simple-section-head span,.paid-services-head span{display:block;margin-bottom:10px;color:#007f70;font-size:13px;font-weight:900;letter-spacing:.08em;text-transform:uppercase}
    .paid-services-head span{color:#8dccff}
    .simple-section-head h2,.paid-services-head h2,.final-cta h2{margin:0;color:#07345f;font-size:clamp(34px,5vw,58px);line-height:.98;letter-spacing:-.04em}
    .paid-services-head h2{color:#fff}
    .simple-section-head p,.paid-services-head p,.final-cta p{max-width:760px;color:#435771;font-size:18px;line-height:1.7}
    .paid-services-head{text-align:center;max-width:900px;margin:0 auto 34px}
    .paid-services-head p{margin:18px auto 0;color:#cfe9ff}
    .steps-grid,.free-tools-grid,.paid-services-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:22px}
    .paid-services-grid{grid-template-columns:repeat(4,minmax(0,1fr));align-items:stretch}
    .steps-grid article,.free-tools-grid a,.service-card{border:1px solid #d7e6f4;border-radius:26px;background:rgba(255,255,255,.86);box-shadow:0 22px 54px rgba(6,45,102,.09)}
    ...
    .service-card{display:flex;min-height:100%;flex-direction:column;padding:28px;background:rgba(255,255,255,.08);border-color:rgba(255,255,255,.18);box-shadow:inset 0 1px 0 rgba(255,255,255,.1),0 22px 54px rgba(2,19,44,.18)}
    .service-card.featured{background:rgba(141,204,255,.13);border-color:rgba(141,204,255,.32)}
    .service-card-top{display:flex;align-items:center;justify-content:space-between;gap:12px;margin-bottom:22px}
    .service-badge{display:inline-flex;padding:9px 14px;border-radius:999px;background:rgba(141,204,255,.2);color:#bfe4ff;font-size:12px;font-weight:900;letter-spacing:.05em;text-transform:uppercase}
    .service-price{color:#bfe4ff;font-size:22px;font-weight:900;white-space:nowrap}
    .service-card h3{color:#fff;font-size:24px;line-height:1.15}
    .service-card p,.service-card li{color:#d8ecff}
    .service-card ul{margin:20px 0 30px;padding-left:20px}
    .service-card li{margin:8px 0;font-size:15px;line-height:1.5}
    .service-cta{margin-top:auto;color:#8dccff;font-size:16px;font-weight:900;text-decoration:none}
    .paid-services-foot{margin:26px 0 0;text-align:center;color:#cfe9ff}
    .paid-services-foot a{color:#fff;font-weight:900}
    ...
    @media(max-width:1100px){.paid-services-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.steps-grid,.free-tools-grid{grid-template-columns:1fr}}
    @media(max-width:980px){.trust-strip{grid-template-columns:repeat(2,minmax(0,1fr))}}
    @media(max-width:760px){.simple-section-head.row{display:block}.paid-services-grid{grid-template-columns:1fr}.how-it-works,.free-tools,.preview-countries,.paid-services,.final-cta{padding:38px 18px}}
    @media(max-width:640px){.trust-strip article{padding:18px 14px}.trust-strip strong{font-size:28px}.service-card{padding:22px}.service-card-top{align-items:flex-start;flex-direction:column}.service-price{white-space:normal}}
  </style>
