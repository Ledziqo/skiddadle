...
?>
<section class="page-hero"><span class="eyebrow">Refusal recovery</span><h1>Turn refusal reasons into an evidence plan.</h1><p>Get a smart, structured recovery plan with practical evidence steps for your next application.</p></section>
