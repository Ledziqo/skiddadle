...
<section class="page-hero visa-hub-hero">
  ...
  <p>Admission letters, funding proof, sponsor documents and official application channels for 25 countries. Every entry links back to the official embassy or government source.</p>
</section>
<section class="visa-hub-tabs">
  <a href="<?= vm_url('student-visa.php') ?>" class="active">Student</a>
