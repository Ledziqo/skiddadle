...
<section class="page-hero visa-hub-hero">
  ...
  <h1>Tourist / Visitor Visa Requirements</h1>
  <p>Travel itineraries, accommodation proof, funding evidence and official application channels for 25 countries. Every entry links back to the official embassy or government source.</p>
</section>
<section class="visa-hub-tabs">
  ...
  <a href="<?= vm_url('tourist-visa.php') ?>" class="active">Tourist</a>
</section>
